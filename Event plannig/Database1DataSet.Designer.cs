...
namespace Event_plannig {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class EventsDataTable : global::System.Data.TypedTableBase<EventsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public EventsRow AddEventsRow(System.Guid EventId, string Name, System.DateTime StartDate, System.DateTime EndDate, string StartTime, string EndTime, string Location, string Description, string Price) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public EventsRow FindByEventId(System.Guid EventId) {
        ...
        public partial class EventsRow : global::System.Data.DataRow {
            ...
            public System.Guid EventId {
                get {
                    return ((global::System.Guid)(this[this.tableEvents.EventIdColumn]));
                }
                set {
            ...
            public string StartTime {
                get {
                    return ((string)(this[this.tableEvents.StartTimeColumn]));
                }
                set {
            ...
            public string EndTime {
                get {
                    return ((string)(this[this.tableEvents.EndTimeColumn]));
                }
                set {
            ...
            public string Price {
                get {
                    return ((string)(this[this.tableEvents.PriceColumn]));
                }
                set {
...
namespace Event_plannig.Database1DataSetTableAdapters {
    ...
    public partial class EventsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Events] WHERE (([EventId] = @Original_EventId) AND ([Name] = @Original_Name) AND ([StartDate] = @Original_StartDate) AND ([EndDate] = @Original_EndDate) AND ([StartTime] = @Original_StartTime) AND ([EndTime] = @Original_EndTime) AND ([Price] = @Original_Price))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Events] ([EventId], [Name], [StartDate], [EndDate], [StartTime], [EndTime], [Location], [Description], [Price]) VALUES (@EventId, @Name, @StartDate, @EndDate, @StartTime, @EndTime, @Location, @Description, @Price);
SELECT EventId, Name, StartDate, EndDate, StartTime, EndTime, Location, Description, Price FROM Events WHERE (EventId = @EventId)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Events] SET [EventId] = @EventId, [Name] = @Name, [StartDate] = @StartDate, [EndDate] = @EndDate, [StartTime] = @StartTime, [EndTime] = @EndTime, [Location] = @Location, [Description] = @Description, [Price] = @Price WHERE (([EventId] = @Original_EventId) AND ([Name] = @Original_Name) AND ([StartDate] = @Original_StartDate) AND ([EndDate] = @Original_EndDate) AND ([StartTime] = @Original_StartTime) AND ([EndTime] = @Original_EndTime) AND ([Price] = @Original_Price));
SELECT EventId, Name, StartDate, EndDate, StartTime, EndTime, Location, Description, Price FROM Events WHERE (EventId = @EventId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Event_plannig.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EventId, Name, StartDate, EndDate, StartTime, EndTime, Location, Descripti" +
                "on, Price FROM dbo.Events";
        ...
        public virtual int Delete(System.Guid Original_EventId, string Original_Name, System.DateTime Original_StartDate, System.DateTime Original_EndDate, string Original_StartTime, string Original_EndTime, string Original_Price) {
            ...
            if ((Original_EndTime == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[5].Value = ((string)(Original_EndTime));
            }
        ...
        public virtual int Insert(System.Guid EventId, string Name, System.DateTime StartDate, System.DateTime EndDate, string StartTime, string EndTime, string Location, string Description, string Price) {
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[9].Value = ((System.Guid)(Original_EventId));
            if ((Original_Name == null)) {
                throw new global::System.ArgumentNullException("Original_Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, System.DateTime StartDate, System.DateTime EndDate, string StartTime, string EndTime, string Location, string Description, string Price, System.Guid Original_EventId, string Original_Name, System.DateTime Original_StartDate, System.DateTime Original_EndDate, string Original_StartTime, string Original_EndTime, string Original_Price) {
            return this.Update(Original_EventId, Name, StartDate, EndDate, StartTime, EndTime, Location, Description, Price, Original_EventId, Original_Name, Original_StartDate, Original_EndDate, Original_StartTime, Original_EndTime, Original_Price);
        }
    }
